...
def _add_regularization_args(parser):
    ...
    # Muon
    group.add_argument('--muon-legacy-matched-adamw-rms', type=float, default=0.2,
                       help="The RMS of the matched AdamW's, typically 0.2 ~ 0.4")
    group.add_argument('--muon-legacy-momentum', type=float, default=0.95,
                       help='Momentum beta for muon-legacy')
    group.add_argument('--muon-legacy-ns-steps', type=int, default=5,
                       help='Number of Newton-Schulz iteration steps for muon-legacy')
    group.add_argument('--no-muon-legacy-nesterov', action='store_false',
                       dest='muon_legacy_nesterov', default=True,
                       help='If set, disable Nesterov momentum for muon-legacy')
    return parser
