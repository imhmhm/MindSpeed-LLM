...
"""Ported from LlamaFactory data/formatter.py. Thin formatter classes that delegate
tool serialization to ToolUtils (extracted design). No ForThink variants, no hardcoded
<think> regex."""
...
class FunctionFormatter(StringFormatter):
    def __post_init__(self):
        super().__post_init__()
        self.tool_utils = get_tool_utils(self.tool_format or "default")
